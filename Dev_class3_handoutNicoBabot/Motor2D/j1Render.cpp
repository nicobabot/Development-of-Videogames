...
{
	bool ret = true;
	config.append_child("camera");
	config = config.child("camera");

	config.append_attribute("camera_x").set_value(camera.x);
	config.append_attribute("camera_y").set_value(camera.y);
